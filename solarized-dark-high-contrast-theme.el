...
(let ((p solarized-dark-high-contrast-palette-alist)
      ...
      (white "#ffffe8")
      (black "#051018"))
  (setcdr (assq 's-base03 p) (solarized-color-blend (alist-get 's-base03 p) black a))
  (setcdr (assq 's-base02 p) (solarized-color-blend (alist-get 's-base02 p) black a))
  (setcdr (assq 's-base01 p) (solarized-color-blend (alist-get 's-base01 p) white a))
  (setcdr (assq 's-base00 p) (solarized-color-blend (alist-get 's-base00 p) white a2))
  (setcdr (assq 's-base0 p) (solarized-color-blend (alist-get 's-base0 p) white a2))
  (setcdr (assq 's-base1 p) (solarized-color-blend (alist-get 's-base1 p) white a2))
  (setcdr (assq 's-base2 p) (solarized-color-blend (alist-get 's-base2 p)  black a))
  (setcdr (assq 's-base3 p) (solarized-color-blend (alist-get 's-base3 p)  black a)))
