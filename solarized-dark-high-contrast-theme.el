...
(let ((p solarized-dark-high-contrast-palette-alist)
  ...
  (setcdr (assq 's-base01 p) (solarized-color-blend (alist-get 's-base01 o) white a  2))
  (setcdr (assq 's-base00 p) (solarized-color-blend (alist-get 's-base00 o) white a2 2))
  (setcdr (assq 's-base0  p) (solarized-color-blend (alist-get 's-base0  o) white a2 2))
  (setcdr (assq 's-base1  p) (solarized-color-blend (alist-get 's-base1  o) white a2 2))
  (setcdr (assq 's-base2  p) (solarized-color-blend (alist-get 's-base2  o) black a  2))
  (setcdr (assq 's-base3  p) (solarized-color-blend (alist-get 's-base3  o) black a  2)))
