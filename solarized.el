...
;;;;; smart-mode-line
     ...
     ;; commented faces use default inheritance from their definitions
     ;; `(sml/global)
     `(sml/modes               ((,class (:weight bold))))
     ;; `(sml/minor-modes)
     `(sml/filename            ((,class (:foreground ,base1 :weight bold))))
     ;; `(sml/prefix)
     `(sml/read-only           ((,class (:foreground ,yellow))))
     `(sml/modified            ((,class (:foreground ,yellow))))
     `(sml/outside-modified    ((,class (:foreground ,red))))
     `(sml/line-number         ((,class (:foreground ,base0 :weight bold))))
     `(sml/remote              ((,class (:foreground ,yellow :weight bold))))
     ;; `(sml/name-filling)
     ...
     `(sml/git                 ((,class (:foreground ,base0))))
     `(sml/folder              ((,class (:foreground ,base0))))
     `(sml/process             ((,class (:foreground ,magenta :weight bold))))
     `(sml/vc                  ((,class (:foreground ,blue))))
     `(sml/vc-edited           ((,class (:foreground ,yellow))))
     `(sml/charging            ((,class (:foreground ,green))))
     `(sml/discharging         ((,class (:foreground ,orange))))
