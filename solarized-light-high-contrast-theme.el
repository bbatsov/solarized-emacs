...
(let ((p solarized-light-high-contrast-palette-alist)
  ...
  (setcdr (assq 's-base01 p) (solarized-color-blend (alist-get 's-base01 p) grey a3 2))
  (setcdr (assq 's-base00 p) (solarized-color-blend (alist-get 's-base00 p) black a 2))
  (setcdr (assq 's-base0 p) (solarized-color-blend (alist-get 's-base0 p) black a2 2))
  (setcdr (assq 's-base1 p) (solarized-color-blend (alist-get 's-base1 p) black a3 2))
  (setcdr (assq 's-base2 p) (solarized-color-blend (alist-get 's-base2 p)  white  a 2))
  (setcdr (assq 's-base3 p) (solarized-color-blend (alist-get 's-base3 p)  white a 2)))
